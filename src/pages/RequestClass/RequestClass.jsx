            ...
            <div className={styles['image-selector']}>
              ...
              {imageFile && (
                ...
                <img
                  ...
                  onClick={handleFileInputClick}
                  className={`${styles['image-uploaded']} ${
                    recentUpload && styles['recent-upload']
                  }`}
                  alt='img-upload'
                />
              )}
