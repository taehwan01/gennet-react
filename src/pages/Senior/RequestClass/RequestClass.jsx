      ...
      <div className={styles['request-class']}>
        ...
        <form className={styles['request-class-form']}>
          <div className={styles['form-solo-div']}>
            ...
            <input type='text' className={styles['form-input-text']} placeholder='제목을 입력하세요.' />
          </div>
          ...
          <div className={styles['form-solo-div']}>
            ...
            <input type='text' className={styles['form-input-text']} placeholder='식사주문' />
          </div>

          <div className={styles['form-solo-div']}>
            <div className={`${styles['form-tag']} ${styles['form-tag-textarea']}`}>
              <span>내용</span>
            </div>
            <textarea
          ...
          <Button action={handleSubmit} buttonStyle={buttonStyle} tag='수업 요청하기' />
        </form>
        <div> </div>
      </div>
    </>
